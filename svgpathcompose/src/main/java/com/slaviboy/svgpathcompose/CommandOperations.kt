...
import com.slaviboy.svgpathcompose.Command.Companion.TYPE_A
import com.slaviboy.svgpathcompose.Command.Companion.TYPE_C
import com.slaviboy.svgpathcompose.Command.Companion.TYPE_H
import com.slaviboy.svgpathcompose.Command.Companion.TYPE_L
import com.slaviboy.svgpathcompose.Command.Companion.TYPE_M
import com.slaviboy.svgpathcompose.Command.Companion.TYPE_NONE
import com.slaviboy.svgpathcompose.Command.Companion.TYPE_Q
import com.slaviboy.svgpathcompose.Command.Companion.TYPE_S
import com.slaviboy.svgpathcompose.Command.Companion.TYPE_T
import com.slaviboy.svgpathcompose.Command.Companion.TYPE_V
import com.slaviboy.svgpathcompose.Command.Companion.TYPE_Z
import com.slaviboy.svgpathcompose.Command.Companion.TYPE_a
import com.slaviboy.svgpathcompose.Command.Companion.TYPE_h
import com.slaviboy.svgpathcompose.Command.Companion.TYPE_v
import com.slaviboy.svgpathcompose.Command.Companion.numberOfCoordinates
...
object CommandOperations {
    ...
    fun parse(data: String): ArrayList<Command> {
        ...
        val splitByLetter = data.split(Regex("(?=[aAcChHlLmMqQsStTvVzZ])"))
        ...
        for (splitText in splitByLetter) {
            ...
            if (splitText.isNotEmpty()) {
                ...
                // get the supposing type and coordinates
